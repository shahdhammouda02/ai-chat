        ...
        <div className="bg-linear-to-r from-indigo-500 to-purple-500 text-white flex justify-between items-center shadow-md sticky top-0 z-20 h-16 px-4 shrink-0">
          ...
          {isLoggedIn ? (
            <button
              ...
              className="bg-white/10 p-2 md:px-4 md:py-1 rounded-md hover:bg-white/20 transition flex items-center gap-2"
            >
          ...
          <>
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4 pl-20 md:pl-6">
              {messages.map((msg, idx) => (
                ...
                >
                  <div
                    className={`max-w-[85%] sm:max-w-[70%] px-4 py-3 rounded-2xl text-sm shadow-sm wrap-break-words ${
                      msg.role === "user"
              ...
              {loading && (
                <div className="flex justify-start">
                  <div className="bg-white/5 border border-white/10 px-4 py-3 rounded-2xl text-sm animate-pulse text-white/40">
                    AI is typing...
                  </div>
                </div>
              )}
...
export default function ChatPage() {
  return (
    <Suspense
      fallback={
        <div className="h-screen bg-[#0d0f14] flex items-center justify-center text-white/50">
          Loading...
        </div>
      }
    >
